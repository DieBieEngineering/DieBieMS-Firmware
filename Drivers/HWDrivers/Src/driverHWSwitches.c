...
{
	{GPIOB,RCC_AHBENR_GPIOBEN,GPIO_PIN_2,GPIO_MODE_OUTPUT_PP,GPIO_NOPULL},		// SWITCH_DRIVER
...
#ifdef TDHVSolar
	{GPIOC,RCC_AHBENR_GPIOCEN,GPIO_PIN_13,GPIO_MODE_INPUT,GPIO_NOPULL}		// SWITCH_Savestate input
#else
