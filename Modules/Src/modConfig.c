...
bool modConfigStoreAndLoadDefaultConfig(void) {
	...
	if(driverSWStorageManagerConfigEmpty) {
		...
		defaultConfig.batteryCapacity														=	8.0f;												// 8Ah battery
		defaultConfig.cellHardUnderVoltage											= 2.50f;												// Worst case 2.8V as lowest cell voltage
		defaultConfig.cellHardOverVoltage												= 4.20f;												// Worst case 4.2V as highest cell voltage
		defaultConfig.cellSoftUnderVoltage											= 2.00f;												// Normal lowest cell voltage 3V
		defaultConfig.cellSoftOverVoltage												= 4.00f;												// Normal highest cell voltage 4.15V
		...
		defaultConfig.maxMismatchThreshold											= 0.025f;												// If mismatch is under this threshold for timoutChargingCompletedMinimalMismatch determin charged
		...
		defaultConfig.maxAllowedCurrent													= 120.0f;												// Allow max 70A trough BMS
		...
		defaultConfig.stateOfChargeStoreInterval								= 60*1000;											// Interval to store state of charge information
